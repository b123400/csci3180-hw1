...
000083 01 SLOPE       PIC -9.9  VALUE ZERO.
000084 01 CELL-VALUE  PIC 9.9   VALUE ZERO.
000084* VARIABLES FOR LOOPING CELLS.
000085 01 CELL-I      PIC 9(2)  VALUE 0.
000086 01 CELL-J      PIC 9(2)  VALUE 0.
000090*
...
101100 LINK-NUMBERS.
101101     READ IN-FILE.
101102     DISPLAY FST-NUM.
101103     MOVE FST-NUM TO POINT-COUNT.
101114     READ IN-FILE.
101115     DISPLAY FST-NUM.
101116     DISPLAY SND-NUM.
...
101124     GO TO LINK-NUMBERS-EXIT.
101130*
...
101201     READ IN-FILE.
101202     DISPLAY FST-NUM.
101203     DISPLAY SND-NUM.
...
102000*
102001 DRAW-LINE.
102002     COMPUTE CELL-I = X1 - X2.
102003     COMPUTE CELL-J = Y1 - Y2.
102004     COMPUTE SLOPE = CELL-J / CELL-I.
102005     DISPLAY SLOPE.
102006     GO TO DRAW-LINE-EXIT.
